...
`
  },
  {
    ...
    faqs: [
      ...
      { q: 'How did Josh Kesselman make his money?', a: 'Primarily through HBI International, the company he founded in 1998, which owns rolling paper brands including RAW, Elements, and Juicy Jay\'s. He also co-owns High Times magazine, acquired in 2025.' },
      { q: 'When did Josh Kesselman start RAW rolling papers?', a: 'He launched RAW in 2005, after years of importing and selling rolling papers through HBI International, which he founded in 1998.' },
      { q: 'What was the Forbes "Pinocchio of Pot" story about?', a: "A 2023 Forbes investigation, based on a lawsuit from rival Republic Technologies, found that Kesselman had made false claims about a RAW factory in Alcoy, Spain, that didn't exist, and had promoted a charitable foundation that wasn't registered as a nonprofit." },
      { q: 'Did Josh Kesselman lose the Republic Technologies lawsuit?', a: "Not entirely. A jury found HBI violated an Illinois deceptive trade practices law, but also sided with HBI's counterclaim that Republic committed copyright infringement, awarding Kesselman's company $1 million in damages." },
      { q: 'Does Josh Kesselman own High Times magazine?', a: 'Yes. In 2025, Kesselman and business partner Matt Stang purchased the High Times brand out of receivership for $3.5 million.' },
      { q: 'How much has Josh Kesselman donated to charity?', a: "Through RAW Giving and HBI International, Kesselman's donations have surpassed $3 million, funding causes including water wells in Ethiopia, homeless services in Arizona, and tree-planting programs." },
      { q: 'Where did Josh Kesselman get his start in business?', a: "He opened a smoke shop called Knuckleheads in Gainesville, Florida in the early 1990s, before founding HBI International in 1998." },
...
<div class="quick-facts">
  ...
  <div class="quick-facts-scroll">
  <table>
    <tr><td>Full Name</td><td>Josh Kesselman</td></tr>
    <tr><td>Age</td><td>47 (per contemporary profiles)</td></tr>
    <tr><td>Profession</td><td>Entrepreneur, founder of RAW rolling papers</td></tr>
    <tr><td>Company</td><td>Founder, HBI International (1998)</td></tr>
    <tr><td>Known Brands</td><td>RAW, Elements, Juicy Jay's</td></tr>
    <tr><td>RAW Launch Year</td><td>2005</td></tr>
    <tr><td>Other Ventures</td><td>Co-owner, High Times magazine (2025)</td></tr>
    <tr><td>Estimated Net Worth (unverified)</td><td>$45 million&ndash;$150 million, depending on source</td></tr>
    <tr><td>Reported Brand Value (RAW, per Forbes)</td><td>Approximately $200 million</td></tr>
    <tr><td>Primary Income Sources</td><td>Rolling paper and smoking-accessory sales, High Times media revenue</td></tr>
  </table>
  </div>
</div>

<h2>Josh Kesselman Net Worth: The Short Answer</h2>
<p>The honest starting point is that nobody outside Kesselman's accountant knows his exact net worth, and he has no obligation to disclose one since HBI International is privately held. The figures circulating online — anywhere from $45 million to $150 million — come from consumer net worth sites building estimates off assumptions about RAW's market share, retail pricing, and Kesselman's visible lifestyle, not from tax filings or audited financials.</p>
<p>Forbes, which covers the cannabis industry more rigorously than most outlets, has separately described RAW as a brand worth around $200 million — a figure about the company, not necessarily Kesselman's personal wealth, since HBI International also owns Elements, Juicy Jay's, and now a stake in High Times.</p>

<h2>From a Manhattan Childhood to a Florida Smoke Shop</h2>
<p>Kesselman grew up in Manhattan, where he has said his interest in rolling papers traces back to childhood memories of his father using rice paper. That early fascination turned into a business in the early 1990s, when Kesselman opened a smoke shop called Knuckleheads in Gainesville, Florida, according to <a href="https://www.inc.com/will-yakowicz/josh-kesselman-raw-rolling-papers.html" target="_blank" rel="nofollow noopener">Inc.'s profile of his career</a>. He spent this period trading rolling papers with collectors across Europe, importing whatever unusual papers he could find, and reselling them to curious customers.</p>
<p>The Gainesville shop didn't last. It was forced to close after an employee sold a bong to the daughter of a high-ranking U.S. Customs Service official — an early lesson in how quickly a smoke shop's fortunes could turn under federal scrutiny.</p>
<p>What that first shop did give Kesselman was a genuine education in the rolling paper trade itself — which brands collectors actually valued, which manufacturing techniques produced a noticeably different smoke, and how thin the margins were for anyone just reselling other companies' products. That hands-on apprenticeship, built over years of buying and trading with European suppliers rather than through any formal business training, shaped the product philosophy he'd later apply to his own brands.</p>

<h2>HBI International: The Company Behind the Brands</h2>
<p>In 1998, Kesselman founded HBI International, initially focused on importing rolling papers and related supplies to sell to smoke shops around the country. Rather than staying purely an importer, he began developing his own house brands — first Elements and Juicy Jay's, and by 2005, RAW.</p>
<p>By the time RAW launched, Kesselman had spent years studying the manufacturing processes European paper makers had used for centuries. His pitch for RAW was straightforward: rolling papers made from unbleached plant fiber, free of the chemicals, dyes, and additives found in traditional white papers — positioned as a purer, more "natural" smoking experience.</p>
<p>That positioning worked. RAW grew into one of the most recognized rolling paper brands in the U.S., with HBI International eventually operating offices across the U.S., Europe, Canada, and Asia to support global distribution.</p>

<h2>What Actually Set RAW Apart</h2>
<p>The rolling paper market Kesselman entered in 2005 was crowded with brands that had been around for decades, most competing on price or on flavor additives. RAW's pitch ran in the opposite direction: fewer processing steps, no bleaching, no added dyes, and packaging that leaned into the "unrefined" look rather than hiding it. That aesthetic — visibly unbleached, brown paper — became almost as recognizable as the product itself, turning a commodity item into something closer to a lifestyle brand.</p>
<p>HBI International backed that positioning with an unusually wide product line for a rolling paper company: papers in multiple sizes and thicknesses, pre-rolled cones, rolling trays, filters, and accessories, all sold under the RAW name alongside the separate Elements and Juicy Jay's brands the company had built earlier. Distribution expanded well beyond U.S. smoke shops into general retail and international markets, which is part of why HBI needed offices spanning multiple continents rather than a single U.S. headquarters.</p>

<h2>The Forbes Investigation: "The Pinocchio of Pot"</h2>
<p>Not every part of the RAW story holds up to scrutiny. In February 2023, Forbes published <a href="https://www.forbes.com/sites/willyakowicz/2023/02/24/josh-kesselman-raw-rolling-papers-lawsuit-pinocchio-of-pot/" target="_blank" rel="nofollow noopener">an investigation nicknamed "The Pinocchio of Pot"</a>, drawing on a lawsuit brought by rival company Republic Technologies. The reporting found that Kesselman had told Forbes in April 2020 that a RAW factory in Alcoy, Spain was actively producing paper — but the factory didn't exist. RAW's papers were actually manufactured in France and merely packaged at the company's Spanish facility.</p>
<p>The lawsuit surfaced a second, stranger claim: HBI had promoted a charitable arm called the "Raw Foundation," but no nonprofit by that name was registered as a 501(c)(3) in public databases. HBI agreed to stop advertising the foundation, and the company said in a statement that its marketing "may have created the impression that we ourselves were a charity."</p>
<p>The legal outcome was mixed rather than one-sided. A jury found that HBI had violated the Illinois Uniform Deceptive Trade Practices Act over the factory claims, but it also sided with HBI's counterclaim that Republic Technologies had committed copyright infringement — awarding Kesselman's company $1 million in damages. It's a case worth understanding before taking any of RAW's public claims, including net worth-adjacent ones, at face value.</p>
<p>The episode is a useful case study in how brand storytelling and factual accuracy can drift apart even for an otherwise successful company. RAW's manufacturing story — European techniques, careful sourcing, a specific factory in a specific Spanish town — was a meaningful part of its marketing appeal to customers who cared about where and how their rolling papers were made. When that particular detail turned out to be fabricated, it didn't erase RAW's actual market success, but it did give outside observers, including anyone trying to estimate Kesselman's wealth, a concrete reason to treat company-sourced claims with some skepticism rather than repeating them uncritically.</p>
<p>See our <a href="/about-us">verification standard</a> for how Richlytic treats claims like this when building a profile.</p>

<h2>Buying High Times: The 2025 Expansion</h2>
<p>In 2025, Kesselman expanded beyond rolling papers into cannabis media. Alongside business partner Matt Stang, he purchased the High Times brand out of receivership for $3.5 million, with the stated goal of reviving the once-dominant cannabis publication. It's a notable pivot — from manufacturing a physical product to owning a media property with decades of brand recognition in the same industry RAW built its business around.</p>
<p>High Times had gone through receivership before the sale, meaning the brand carried real name recognition but also real financial baggage — a very different kind of acquisition than launching a product line from scratch, the way Kesselman built RAW. Reviving a legacy media brand typically means rebuilding advertiser relationships, a subscriber or readership base, and digital presence largely from the ground up, even when the name itself still carries weight in the industry. How much of that turnaround has translated into actual revenue for Kesselman and Stang isn't public information.</p>
<p>This kind of diversification is exactly why a single net worth number is so hard to pin down: Kesselman's holdings now span manufacturing, retail brands, and media, each with a different (and largely undisclosed) revenue picture.</p>

<h2>RAW Giving and the Josh Kesselman Foundation</h2>
<p>Separate from the disputed "Raw Foundation" claims uncovered by Forbes, Kesselman's philanthropic effort — branded RAW Giving — has a documented donation record. Reporting has put total giving at over $3 million, with 2024 contributions including $100,000 to the Weldon Project, $50,000 to Home Fur Good, and $100,000 to Central Arizona Shelter Services. The company has also funded water wells and hospital support in Ethiopia and partnered with Trees for the Future on a project to sponsor the planting of 500,000 trees.</p>
<p>More recently, this giving was formalized under the Josh Kesselman Foundation, consolidating years of ad hoc philanthropic commitments — including global water access projects and local community assistance — under a single organized structure, distinct from the earlier, improperly marketed "Raw Foundation."</p>
<p>The distinction matters for anyone trying to fairly evaluate Kesselman's public record: the "Raw Foundation" naming issue that surfaced in the Forbes reporting was a genuine marketing misstep, but the underlying donations — the Ethiopia water wells, the Arizona shelter funding, the tree-planting partnership — appear to be real, documented giving rather than fabricated activity. The problem Forbes identified was about how the charitable arm was labeled and registered, not whether the money moved at all.</p>

<h2>Where the Money Actually Comes From</h2>
<p>Stripped of the estimate-driven headline numbers, Kesselman's income sources break down into a few concrete categories. The largest is almost certainly product sales across RAW, Elements, and Juicy Jay's, sold through smoke shops, general retail, and international distributors. A smaller and newer slice comes from High Times, assuming the 2025 acquisition has started generating meaningful advertiser or subscription revenue rather than still being in a rebuilding phase. None of HBI International's brands file public earnings reports, so there's no way to weight these categories against each other with any precision — which is exactly the gap that consumer net worth sites paper over with assumptions.</p>

<h2>How These Net Worth Estimates Actually Get Made</h2>
<p>It helps to understand why the numbers vary this much. Consumer net worth sites don't have access to HBI International's tax filings, sales figures, or profit margins, since it's a private company with no obligation to disclose any of that. Instead, most estimates are built by guessing at RAW's retail market share and unit sales, comparing HBI's footprint to competitors with known revenue, factoring in Kesselman's visible business expansions (like the High Times purchase) as a rough signal of available capital, then rounding to a number that sounds plausible for a founder in his position.</p>
<p>That's not necessarily dishonest, but it's estimation stacked on estimation — not verification, and the Forbes factory episode is a direct reminder of how much of the public record around Kesselman and RAW has, at times, been shaped by the company's own marketing rather than independently confirmed facts. It's also worth noting that a "$200 million brand" figure and a "personal net worth" figure aren't the same thing, and sites that treat them interchangeably are already on shaky ground. Browse more <a href="/net-worth">verified net worth profiles</a> of entrepreneurs whose wealth is similarly tied up in privately held companies.</p>

<h2>Personal Life</h2>
<p>Kesselman keeps a relatively industry-focused public profile, appearing mostly in cannabis trade press and interviews tied to RAW, HBI International, or his philanthropic work rather than general celebrity coverage. His public reputation is closely tied to RAW's "unbleached, natural" branding — and, since 2023, to the Forbes reporting that complicated parts of that same brand story. See our <a href="/net-worth">full net worth database</a> for other entrepreneurs whose public image and documented business history don't fully line up.</p>
<p>That combination — a founder who built a genuinely large, globally distributed brand from a single Florida smoke shop, while also getting caught embellishing parts of that same story under legal scrutiny — is unusual enough to make Kesselman a harder subject to summarize than most net worth profiles. Readers who only encounter the "self-made rolling paper mogul" version of the story, or only the "Pinocchio of Pot" version, are getting half the picture either way. It's a similar pattern to what we found reporting on <a href="/ben-meiselas-net-worth-2026">Ben Meiselas's net worth</a> — a documented, real career alongside a wide spread of unverified public estimates.</p>

<h2>A Quick Timeline</h2>
<div class="quick-facts">
<div class="quick-facts-scroll">
<table>
  <tr><td>Early 1990s</td><td>Opens Knuckleheads smoke shop in Gainesville, Florida</td></tr>
  <tr><td>1998</td><td>Founds HBI International, importing rolling papers</td></tr>
  <tr><td>2005</td><td>Launches RAW rolling papers</td></tr>
  <tr><td>April 2020</td><td>Tells Forbes the Alcoy, Spain factory is active; later shown not to exist</td></tr>
  <tr><td>February 2023</td><td>Forbes publishes "The Pinocchio of Pot" investigation</td></tr>
  <tr><td>2025</td><td>Acquires High Times brand with Matt Stang for $3.5 million</td></tr>
</table>
</div>
</div>

<h2>Conclusion</h2>
<p>The RAW rolling papers story is genuinely two-sided: a real, well-documented entrepreneurial run from a small Florida smoke shop to a globally distributed brand, alongside a well-documented set of exaggerated claims that Forbes and a public lawsuit exposed in detail. Both are part of the accurate record, and treating either half alone would miss what actually happened.</p>
<p>What doesn't hold up is repeating any single net worth figure as settled fact. Between the wide range of estimates, the separate (and larger) brand valuation, and a company with no public financial disclosures, the honest position is that Kesselman's exact wealth simply isn't independently verifiable right now.</p>

<div class="post-faq">
  <details><summary>What is Josh Kesselman's net worth?</summary><p>There's no confirmed figure. Estimates vary widely, from around $45 million on some sites to $100-150 million on others, while Forbes has described the RAW brand itself as being worth roughly $200 million. None of these numbers are independently verified, since Kesselman's companies are privately held.</p></details>
  <details><summary>How did Josh Kesselman make his money?</summary><p>Primarily through HBI International, the company he founded in 1998, which owns rolling paper brands including RAW, Elements, and Juicy Jay's. He also co-owns High Times magazine, acquired in 2025.</p></details>
  <details><summary>When did Josh Kesselman start RAW rolling papers?</summary><p>He launched RAW in 2005, after years of importing and selling rolling papers through HBI International, which he founded in 1998.</p></details>
  <details><summary>What was the Forbes "Pinocchio of Pot" story about?</summary><p>A 2023 Forbes investigation, based on a lawsuit from rival Republic Technologies, found that Kesselman had made false claims about a RAW factory in Alcoy, Spain, that didn't exist, and had promoted a charitable foundation that wasn't registered as a nonprofit.</p></details>
  <details><summary>Did Josh Kesselman lose the Republic Technologies lawsuit?</summary><p>Not entirely. A jury found HBI violated an Illinois deceptive trade practices law, but also sided with HBI's counterclaim that Republic committed copyright infringement, awarding Kesselman's company $1 million in damages.</p></details>
  <details><summary>Does Josh Kesselman own High Times magazine?</summary><p>Yes. In 2025, Kesselman and business partner Matt Stang purchased the High Times brand out of receivership for $3.5 million.</p></details>
  <details><summary>How much has Josh Kesselman donated to charity?</summary><p>Through RAW Giving and HBI International, Kesselman's donations have surpassed $3 million, funding causes including water wells in Ethiopia, homeless services in Arizona, and tree-planting programs.</p></details>
  <details><summary>Where did Josh Kesselman get his start in business?</summary><p>He opened a smoke shop called Knuckleheads in Gainesville, Florida in the early 1990s, before founding HBI International in 1998.</p></details>
  <details><summary>Why do net worth estimates for Josh Kesselman vary so much?</summary><p>Because HBI International and its brands are privately held with no public financial filings. Every estimate online is built from assumptions about revenue and market position, not verified financial records.</p></details>
</div>
`
  },
  {
    slug: 'ben-meiselas-net-worth-2026',
    title: 'Ben Meiselas Net Worth 2026: Real Facts',
    seoTitle: 'Ben Meiselas Net Worth 2026: Income, Career & Verified Facts',
    excerpt: "Ben Meiselas net worth 2026: no confirmed figure exists, but third-party estimates range from $1.5M to $10M. Here's what's actually documented about his legal career and MeidasTouch.",
    metaDescription: "Ben Meiselas net worth 2026: how the Geragos & Geragos partner and MeidasTouch co-founder built his career — Kaepernick, Fyre Festival, and why net worth estimates vary so much.",
    date: '2026-07-23',
    author: 'Richlytic Editorial',
    netWorth: '$1.5M - $10M',
    ...
    faqs: [
      ...
      { q: 'How does Ben Meiselas make his money?', a: 'Mainly through his legal practice at Geragos & Geragos, plus his ownership stake in the media company MeidasTouch.' },
      { q: "What law firm is Ben Meiselas a partner at?", a: 'Geragos & Geragos, based in Los Angeles.' },
      { q: "What is Ben Meiselas's most famous case?", a: "His representation of Colin Kaepernick in the collusion grievance against the NFL is probably his highest-profile case, alongside serving as lead counsel in the Fyre Festival class action." },
      { q: 'When did Ben Meiselas found MeidasTouch?', a: 'In March 2020, together with his brothers Brett and Jordan Meiselas.' },
      { q: 'Is MeidasTouch a news outlet or a PAC?', a: 'Both terms get used for it — it operates as a media company (YouTube, podcasts) alongside a connected political action committee.' },
      { q: 'Where did Ben Meiselas go to law school?', a: 'Georgetown University Law Center, graduating in 2010.' },
      { q: 'Why do net worth estimates for Ben Meiselas vary so much?', a: "Because none of the sites publishing these numbers have access to his actual income records. They're building estimates from public reputation and guesswork, not verified financial data." },
...
<div class="quick-facts">
  ...
  <div class="quick-facts-scroll">
  <table>
    <tr><td>Full Name</td><td>Ben Meiselas</td></tr>
    <tr><td>Reported Date of Birth</td><td>May 19, 1985 (per secondary bio sources, not independently confirmed)</td></tr>
    <tr><td>Profession</td><td>Attorney, media entrepreneur</td></tr>
    <tr><td>Law Firm</td><td>Partner, Geragos &amp; Geragos (Los Angeles)</td></tr>
    <tr><td>Law School</td><td>Georgetown University Law Center (2010)</td></tr>
    <tr><td>Known Legal Cases</td><td>Colin Kaepernick v. NFL, Fyre Festival class action</td></tr>
    <tr><td>Media Company</td><td>Co-founder, MeidasTouch (2020)</td></tr>
    <tr><td>Co-founders</td><td>Brett Meiselas, Jordan Meiselas (brothers)</td></tr>
    <tr><td>Estimated Net Worth (unverified)</td><td>$1.5 million&ndash;$10 million, depending on source</td></tr>
    <tr><td>Primary Income Sources</td><td>Legal fees (contingency and hourly), MeidasTouch media revenue</td></tr>
  </table>
  </div>
</div>

<h2>Ben Meiselas Net Worth: The Short Answer</h2>
<p>Short answer: nobody outside his accountant actually knows, and that's the honest starting point. Meiselas has never released a net worth figure, and unlike a CEO of a public company or an elected official filing a financial disclosure, he has no legal obligation to.</p>
<p>The numbers floating around — mostly in the $5 million to $10 million range, with a few outliers as low as $1.5 million — come from a cluster of "net worth" websites that build estimates off assumptions: rough guesses about legal fees, YouTube ad revenue, and visible lifestyle. What's more useful than chasing a number is looking at where his money would plausibly come from, because that part actually is documented.</p>

<h2>Who Is Ben Meiselas, Before the Net Worth Headlines</h2>
<p>Long before "MeidasTouch" was a name people recognized, Meiselas was building a fairly conventional legal and political résumé. He earned his law degree from Georgetown University Law Center, graduating in 2010, after a B.A. in Political Science from George Washington University — a career path confirmed in <a href="https://variety.com/2019/music/news/colin-kaepernick-attorney-ben-meiselas-diddy-hillary-clinton-1203184719/" target="_blank" rel="nofollow noopener">Variety's 2019 profile</a> of his early career.</p>
<p>That mix of legal training plus political and entertainment exposure turned out to be a fairly accurate preview of the career he ended up building: part courtroom, part media company.</p>

<h2>The Legal Career: Where the Steady Income Actually Comes From</h2>
<p>Meiselas is a partner at <a href="https://www.geragos.com/attorney-profiles/ben-meiselas" target="_blank" rel="nofollow noopener">Geragos &amp; Geragos</a>, the Los Angeles firm known for taking on high-visibility clients. His own practice spans personal injury, civil rights, class actions, and business disputes, and he's been recognized on the <a href="https://profiles.superlawyers.com/california/los-angeles/lawyer/ben-meiselas/c11d855e-03c7-4ad6-a9d8-0373488b98fb.html" target="_blank" rel="nofollow noopener">Super Lawyers "Rising Stars" list</a> every year from 2013 through 2025 — a peer-nominated honor, not a self-reported one.</p>
<p>Two cases stand out on his record. <strong>Colin Kaepernick v. NFL</strong> — Meiselas represented Kaepernick in his collusion grievance against the league, and continues to be involved in Kaepernick-related legal matters. <strong>The Fyre Festival class action</strong> — Meiselas served as lead counsel representing consumers who sued over the infamous failed 2017 festival, <a href="https://www.huffpost.com/entry/fyre-festival-documentaries-laywer_n_5c3e5d70e4b0922a21d9984d" target="_blank" rel="nofollow noopener">securing a settlement</a> that paid out to hundreds of attendees.</p>
<p>Class action and contingency work can pay very well, but it's also lumpy — a big settlement one year, nothing dramatic the next. That unpredictability is a big part of why any net worth estimate built on legal income alone is shaky.</p>

<h2>MeidasTouch: The Media Business Nobody Predicted</h2>
<p>In March 2020, Meiselas and his brothers Brett and Jordan launched MeidasTouch — a fast-turnaround political content operation for YouTube that grew into a full progressive media network spanning YouTube shows, podcasts, and a connected political action committee.</p>
<p>This is the part of his income that's genuinely hard to estimate from the outside. MeidasTouch is privately held, with no public filing that breaks out revenue, let alone what portion flows to Meiselas personally versus back into the business. Any number attached to "his share of MeidasTouch" is, at best, an educated guess.</p>
<p>See our full <a href="/net-worth">net worth database</a> for other public figures whose income mixes law, media, and business ownership the same way.</p>

<h2>How These Net Worth Estimates Actually Get Made</h2>
<p>It's worth pulling back the curtain on this, because it explains the wide spread in the numbers. Most consumer net worth sites don't have access to tax returns, court settlement records, or private company revenue. Instead, they typically estimate legal-industry income based on job title and firm reputation rather than actual case outcomes, guess at media revenue using public subscriber counts and rough ad-rate averages, factor in visible lifestyle signals as a loose sanity check, then round to a number that sounds plausible.</p>
<p>None of that is inherently dishonest, but it's also not verification — it's estimation stacked on estimation. See our <a href="/about-us">verification standard</a> for how Richlytic approaches estimates like this one.</p>

<h2>Personal Life</h2>
<p>Public details about Meiselas's personal life are thin compared to his professional footprint. He's the middle of the three Meiselas brothers behind MeidasTouch, and keeps a relatively low profile outside of his legal and media work. Browse more <a href="/net-worth">verified net worth profiles</a> of attorneys and media figures with similarly mixed income sources.</p>

<h2>A Quick Timeline</h2>
<div class="quick-facts">
<div class="quick-facts-scroll">
<table>
  <tr><td>2010</td><td>Graduates Georgetown University Law Center</td></tr>
  <tr><td>2013&ndash;2025</td><td>Named to Super Lawyers "Rising Stars" list annually</td></tr>
  <tr><td>2017</td><td>Fyre Festival collapses; Meiselas later becomes lead counsel on the resulting class action</td></tr>
  <tr><td>March 2020</td><td>Co-founds MeidasTouch with brothers Brett and Jordan</td></tr>
  <tr><td>Ongoing</td><td>Represents Colin Kaepernick in matters connected to his NFL grievance</td></tr>
</table>
</div>
</div>

<h2>Conclusion</h2>
<p>The honest takeaway here is less exciting than a clean headline number, but it's the accurate one: Ben Meiselas has built a genuinely two-track career — a serious legal practice with real, documented high-profile cases, and a media company that grew from a pandemic-era side project into a national platform. Both plausibly generate real income.</p>
<p>What doesn't hold up is treating any specific net worth figure you find online as settled fact, since none of the sites publishing those numbers have access to the records that would actually confirm them. The smarter move is understanding his income sources rather than repeating any unverified figure.</p>

<div class="post-faq">
  <details><summary>What is Ben Meiselas's net worth?</summary><p>There's no confirmed figure. Third-party estimates range from about $1.5 million to $10 million, but none are independently verified.</p></details>
  <details><summary>How does Ben Meiselas make his money?</summary><p>Mainly through his legal practice at Geragos &amp; Geragos, plus his ownership stake in the media company MeidasTouch.</p></details>
  <details><summary>What law firm is Ben Meiselas a partner at?</summary><p>Geragos &amp; Geragos, based in Los Angeles.</p></details>
  <details><summary>What is Ben Meiselas's most famous case?</summary><p>His representation of Colin Kaepernick in the collusion grievance against the NFL is probably his highest-profile case, alongside serving as lead counsel in the Fyre Festival class action.</p></details>
  <details><summary>When did Ben Meiselas found MeidasTouch?</summary><p>In March 2020, together with his brothers Brett and Jordan Meiselas.</p></details>
  <details><summary>Is MeidasTouch a news outlet or a PAC?</summary><p>Both terms get used for it — it operates as a media company (YouTube, podcasts) alongside a connected political action committee.</p></details>
  <details><summary>Where did Ben Meiselas go to law school?</summary><p>Georgetown University Law Center, graduating in 2010.</p></details>
  <details><summary>Why do net worth estimates for Ben Meiselas vary so much?</summary><p>Because none of the sites publishing these numbers have access to his actual income records. They're building estimates from public reputation and guesswork, not verified financial data.</p></details>
  <details><summary>Is Ben Meiselas still practicing law while running MeidasTouch?</summary><p>Yes, he continues to work as a partner at Geragos &amp; Geragos alongside his media work.</p></details>
</div>
`
  }
];
